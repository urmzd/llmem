...
TurboQuant vector quantization for llmem — near-optimal MSE and inner-product quantizers.
...
```rust
use llmem_quant::{TurboQuantMse, TurboQuantProd, CompressedEmbeddingStore};
```
