...
RAG HTTP server for [llmem](https://github.com/urmzd/llmem) — the open ecosystem for tool-agnostic AI agent memory.
...
The server is optional — llmem works without it. Use the server when you need HTTP-based search for RAG pipelines.
